                                ...
                                <div className="grid gap-6 grid-cols-3">
                                    <div className="p-6 flex items-center border border-[#F58220] rounded-lg gap-4">
                                        <div className="bg-[#FDE6D5] h-16 w-16 inline-flex justify-center items-center rounded-full">
                                            <svg stroke="#F58220" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="32" width="32" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <table class="w-full divide-y divide-default-200">
                                        <thead>
                                            <tr className="bg-[#F1F5F9]">
                                                <th scope="col" class="px-4 py-4 text-start text-sm font-semibold text-default-800">Date</th>
                                        ...
                                        <tbody class="divide-y divide-default-200">
                                            <tr>
                                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">12/03/2022</td>
                                                <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-default-600">#C0E4F7</td>
                                                ...
                                                <td class="px-4 py-4 whitespace-nowrap text-sm text-default-600">$359.69</td>
                                            </tr>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-col gap-4 bg-[#FFF2E9] p-2 rounded-lg">
                                            <div className="flex items-center gap-2">
                                                <img src="./images/Dashboard/pizza.png" alt="" className="h-16 max-w-16" />
